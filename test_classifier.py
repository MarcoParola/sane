...
def main(cfg):
    ...
    # CIFAR10 small
    #checkpoint = torch.load("checkpoints/tune_zoo_cifar10_uniform_small/NN_tune_trainable_86fd7_00999_999_seed=1000_2021-09-27_00-48-09/checkpoint_000050/checkpoints", weights_only=False)
    # CIFAR10 large
    ...
    # sparsified
    checkpoints = torch.load("checkpoints/sparsified_zoos/small_cnn_cifar10_magnitude_sparsity_0.5/checkpoint_999.pt", weights_only=False)
    model.load_state_dict(checkpoints)
    model.eval()
    metrics = test_classifier(model, test, num_classes, batch_size, device, remapping)
    print(metrics)
