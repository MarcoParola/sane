...
def prune_small_cnn(store_location, checkpoint, dataset_name, data_dir, model_name, img_size, sparsity_level):
    ...
    #    print(f"Pruned checkpoint for sparsity {sparsity_level} already exists. Skipping...")
    #    continue
