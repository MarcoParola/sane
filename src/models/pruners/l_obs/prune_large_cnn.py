...
def prune_large_cnn(store_location, checkpoint, dataset_name, data_dir, model_name, img_size, sparsity_level):
    ...
    for layer_name in layer_name_list:
        ...
        if layer_name in ['module_list.0', 'module_list.4', 'module_list.8']:
        ...
        elif layer_name in ['module_list.13', 'module_list.16']:
    ...
    cr_save_dir = Path(f"checkpoints/sparsified_zoos/{model_name}_{dataset_name}_l_obs_sparsity_{sparsity_level}") / current_zoo_model_path
    ...
    for layer_name in layer_name_list:
        ...
        l1, l2 = wb.shape
        n_prune = int(l1*l2*sparsity_level)            
