...
from src.datasets.weights.tokenized_model_weights import TokenizedModelWeightDataset
...
def main(cfg):
    ...
    checkpoint_callback = ModelCheckpoint(
        dirpath=Path("checkpoints", *log_run.split("."), "best"),
    ...
    trainer.fit(sane_model, trainloader)
